...
@admin_bprt.route('/admin/dashboard')
def admin_dashboard():
    # Here you can later load stats, users count, etc.
    return render_template('admin/dashboard.html')

# Admin - Set Wallet Addresses
@admin_bprt.route('/admin/set-wallets', methods=['GET', 'POST'])
...
@admin_bprt.route('/admin/update_balance', methods=['GET', 'POST'])
def update_balance():
...
@admin_bprt.route('/admin/manage-users')
def manage_users():
...
@admin_bprt.route('/admin/view-user/<user_id>')
...
@admin_bprt.route('/admin/update-user-balance/<user_id>', methods=['POST'])
...
@admin_bprt.route('/admin/delete-user/<user_id>', methods=['POST'])
...
@admin_bprt.route('/admin/review-kyc', methods=['GET'])
...
@admin_bprt.route('/admin/approve-kyc/<int:user_id>', methods=['GET'])
...
@admin_bprt.route('/admin/reject-kyc/<int:user_id>', methods=['GET'])
...
@admin_bprt.route('/admin/support', methods=['GET'])
def support_page():
...
@admin_bprt.route('/admin/manage-transactions', methods=['GET'])
