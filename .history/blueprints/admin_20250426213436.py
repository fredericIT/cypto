...
def admin_set_wallets():
    ...
    # Preload existing addresses if needed
    eth_wallet = ETHWallet.query.first()
    btc_wallet = BTCWallet.query.first()
    usdt_wallet = USDTWallet.query.first()
    bnb_wallet = BNBWallet.query.first()
