...
def register():
    ...
    if request.method == 'POST': 
        ...
        account = Account(user_id=user.id, account_status='active', ETH=100, BTC=100, BNB=100, USDT=100)
        ...
        BTC_address = BTCWallet(
            user_id=user.id,
            deposit="bc1q7de9dfykxvmd46lt8t5m52tgce02v5rydgha9s",
            withdraw= "bc1q7de9dfykxvmd46lt8t5m52tgce02v5rydgha9s",
        ...
        BNB_address = BNBWallet(
            user_id=user.id,
            deposit="0xFB09516369E8a4d241aaD7B67B1D75fc290DD085",
            withdraw="0xFB09516369E8a4d241aaD7B67B1D75fc290DD085",
        ...
        USDT_address = USDTWallet(
            user_id=user.id,
            deposit="TJHDfZkTp7w6r9RXqUa49dBhBpP2ydJrWh",
            withdraw= "TJHDfZkTp7w6r9RXqUa49dBhBpP2ydJrWh",
