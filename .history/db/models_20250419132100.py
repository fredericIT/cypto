...
class User(UserMixin, db.Model):
    ...
    btc_wallet = db.relationship('BTCWallet', back_populates='user', cascade='all, delete-orphan')
    eth_wallet = db.relationship('ETHWallet', back_populates='user', cascade='all, delete-orphan')
    usdt_wallet = db.relationship('USDTWallet', back_populates='user', cascade='all, delete-orphan')
    bnb_wallet= db.relationship('BNBWallet', back_populates='user', cascade='all, delete-orphan')
